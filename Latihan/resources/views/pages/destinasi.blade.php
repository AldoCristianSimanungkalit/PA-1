...
<section class="destinasi-hero">
    <div class="container">
        ...
        <div data-aos="fade-up" data-aos-delay="200">
            ...
            <button class="filter-btn" data-filter="budaya">Budaya & Sejarah</button>
    ...
    <div class="destinasi-grid" id="destinasiGrid">
        ...
        <div class="dest-card" data-category="budaya sejarah petualangan" data-aos="fade-up" data-aos-delay="0">
            ...
            <div class="dest-info">
                ...
                <div class="dest-location">
                    ...
                    <span>Bukit Tele, Toba</span>
                </div>
                <p class="dest-desc">Bukit Tele menawarkan panorama Danau Toba dari ketinggian yang spektakuler. Spot favorit untuk menikmati sunrise, berkemah, dan fotografi lanskap. Udara sejuk dan hamparan hijau membuat Anda betah berlama-lama.</p>
                <div class="dest-tags">
                    <span>🏕️ Camping</span>
                    <span>🌅 Sunrise</span>
                    <span>📸 Spot Foto</span>
        ...
        <div class="dest-card" data-category="budaya sejarah" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="dest-info">
                ...
                <p class="dest-desc">Desa adat Efrata adalah pusat pelestarian budaya Batak Toba. Nikmati tarian Tortor, dengarkan musik Gondang, dan saksikan proses pembuatan Ulos. Rumah adat bolon yang masih berdiri kokoh menjadi saksi sejarah leluhur.</p>
                <div class="dest-tags">
        ...
        <div class="dest-card" data-category="geologi petualangan" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="dest-info">
                ...
                <p class="dest-desc">Kawasan Sihotang menyajikan formasi batuan vulkanik yang unik hasil letusan supervolcano Toba. Tebing-tebing curam dan gua-gua alami menanti untuk dijelajahi. Spot favorit fotografer untuk menangkap keindahan alam yang dramatis.</p>
                <div class="dest-tags">
